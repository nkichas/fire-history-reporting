...
#| context: setup
# ---- Load data ----
YELL_Fire <- read_csv(path(wDir, "Fire Statistics/YELL_Fires_2025.csv")) # 2024
INFORM_Fire <- read_csv(path(wDir, "Fire Statistics/Yellowstone_INFORM_Incidents_2025.csv")) # 2024
